...
import com.prod.sudesi.lotusherbalsnew.sudesi.image.ImageModel;
...
*/
    ...
    public void Insertstock(//String product_id,
        ...
        Log.e("value insert into stock", "");

        //values.put("product_id", product_id);
        values.put("product_category", product_cat);
        values.put("product_type", product_type);
        values.put("product_name", product_name);
        Log.e("value insert into stock", "emp_id==" + emp_id);
...
*/
    ...
    public Cursor getReportforStock1(String ProdCategory, String outletCode) {
        // TODO Auto-generated method stub
        ...
        String selectquery = "SELECT DISTINCT Customers.id, Orders.CategoryId ,Orders.db_id, Orders.EANCode, Orders.ProductCategory ," +
                "Orders.ProductType ,Orders.ProductName ,Orders.Size ,Orders.MRP,Customers.emp_id, Customers.opening_stock ," +
                "Customers.stock_received,Customers.stock_in_hand,Customers.close_bal,Customers.return_saleable," +
                "Customers.return_non_saleable,Customers.sold_stock ,Customers.total_gross_amount,Customers.total_net_amount," +
                "Customers.discount,Customers.savedServer,Customers. insert_date ,Customers.shadeNo,Customers.outletcode FROM product_master Orders," +
                "stock Customers where Orders.db_id=Customers.db_id and Orders.ProductCategory = '" + ProdCategory + "' " +
                "and Customers.outletcode = '" + outletCode + "' order by Orders.order_flag";  // new join query with Product Master table 11.05.2015//04.07.2015
...
*/
    ...
    public Cursor getuniquedata2(String categoryid, String eancode, String d_id, String chk_date, String outletcode) {
        // TODO Auto-generated method stub
        //String sql = "select * from stock where " + " db_id ="+"'"+d_id+"'";

        String sql = "select * from stock where outletcode = " + "'" + outletcode + "'" + " and db_id=" + "'" + d_id + "'";
...
//	String selectquery = "select * from product_master where ProductCategory = "+"'"+ selected_category+"'"+" AND ProductType = "+"'"+selected_type+"' AND ProductName = '"+product_name+"'  AND db_id in (select db_id  from stock where close_bal > 0 and product_name = '"+product_name+"') ORDER BY order_flag ";
    ...
    public Cursor fetchAllproductslistforstockforsale1(String selected_category,
                                                       String selected_type, String flag, String product_name, String outletcode) {
        // TODO Auto-generated method stub

//	String selectquery = "select * from product_master where ProductCategory = "+"'"+ selected_category+"'"+" AND ProductType = "+"'"+selected_type+"' AND ProductName = '"+product_name+"'  AND db_id in (select db_id  from stock where close_bal > 0 and product_name = '"+product_name+"') ORDER BY order_flag ";

        String selectquery = "select * from stock where product_category = " + "'" + selected_category + "'" + " AND product_type = " + "'" + selected_type + "' " + " AND outletcode = " + "'" + outletcode + "' AND product_name = '" + product_name + "'  AND  close_bal > 0";
...
//		String selectquery = "select * from product_master where ProductCategory = "+"'"+ selected_category+"'"+" AND ProductType = "+"'"+selected_type+"' ORDER BY order_flag ";// ORDER BY order_flag +" AND price_type = "+"'"+flag+"'";
        ...
        String selectquery = "select distinct(ProductName) from product_master where ProductCategory = " + "'" + selected_category + "'" + " AND ProductType = " + "'" + selected_type + "' ORDER BY order_flag ";// ORDER BY order_flag +" AND price_type = "+"'"+flag+"'";
...
//		Log.e("selectquery distinct","=="+selectquery);
    ...
    public Cursor fetchAllproductslistforstock2(String selected_category,
                                                String selected_type, String flag, String outletcode) {
        // TODO Auto-generated method stub
//		String selectquery = "select * from product_master where ProductCategory = "+"'"+ selected_category+"'"+" AND ProductType = "+"'"+selected_type+"' ORDER BY order_flag ";// ORDER BY order_flag +" AND price_type = "+"'"+flag+"'";

        String selectquery = "select distinct(product_name) ProductName from stock where product_category = " + "'" + selected_category + "'" + " AND product_type = " + "'" + selected_type + "'  " + " AND outletcode = " + "'" + outletcode + "' ORDER BY flag ";// ORDER BY order_flag +" AND price_type = "+"'"+flag+"'";
...
//		Log.e("selectquery distinct","=="+selectquery);
    ...
    public void insertProductMasterFirsttime(String db_stock_id, String id, String productId,
                                             ...
                                             String lMD, String androidCreatedDate, String month, String year, String outletCode) {
        // TODO Auto-generated method stub
        ...
        values.put("outletcode", outletCode);
...
//				strCustTypeID = "";
    ...
    public void UpdateStockSync(//String product_id,
        ...
        String sql = "update stock set close_bal = " + "'" + cl_stk + "'" + ", stock_in_hand = " + "'" + op_stk + "'" + " , outletcode = " + "'" + outletCode + "'" +
                " ,return_saleable = " + "'" + new_retn + "'" + " ,return_non_saleable = " + "'" + new_rtn_n_sold + "'" +
                ",stock_received = " + "'" + fresh_stock1 + "'" + ",sold_stock = " + "'" + sold_stk + "'" + ",total_gross_amount = " + "'" + ttl_amount + "'" +
                ",total_net_amount = " + "'" + ttnamt + "'" + ",discount = " + "'" + disc + "'" + ",opening_stock = " + "'" + p_balance + "'" +
...
//---------------------------------------------------------------------stock activity-------------------------------------------------//
    ...
    public void Insertstock_new1(
            ...
            String return_saleable, String return_non_saleable, String shadno, String updateDate, String month_name, String year_name, String outletcode) {
        // TODO Auto-generated method stub
    ...
    public void UpdateStock_new(String product_cat,
        ...
        String sql = "update stock set  stock_in_hand = " + "'" + stockinhand + "'" +
                ...
                "insert_date = " + "'" + date + "'" +
                ", flag = " + "'s'" +
                ", savedServer='0',updateDate ='" + updateDate + "' ,month='" + month_name + "', year='" + year_name + "'" +
                " where db_id = " + "'" + db_id1 + "'" + "";
    ...
    public void UpdateStock_new1(String product_cat,
                                 String product_type, String product_name,
                                 String emp_id,
                                 String stockinhand,
                                 String cl_stk,
        ...
        String sql = "update stock set  stock_in_hand = " + "'" + stockinhand + "'" +
                ...
                ", flag = " + "'s'" +
                ", savedServer='0',updateDate ='" + updateDate + "' ,month='" + month_name + "', year='" + year_name + "'" +
                " where outletcode = " + "'" + outletcode + "'"+" and db_id = " + "'" + db_id1 + "'" + "";
        Log.e("", "update stock sql==" + sql);
        database.execSQL(sql);
...
//				SELECT * from Table1 where myDate = (select max(myDate) from Table1 WHERE myDate < DATE('now') )
    ...
    public String fetchDbID1(String productName, String mrp, String type, String outletcode) {
        //String sql = "select db_id from stock where product_name like '%"+productName+"%' and price = '"+mrp+"'";
        String sql = "select db_id from stock where product_name like '%" + productName + "%' and price = '" + mrp + "' and outletcode = '" + outletcode + "' and product_category='" + type + "'";
...
//			String sql = "select db_id from stock where product_name like '%"+productName+"%' and price = '"+mrp+"'";
    ...
    public void insertoutlet(String outletcode, String outletname) {
        ContentValues values = new ContentValues();
        values.put("outletcode", outletcode);
        values.put("outletname", outletname);

        database.insert("outlet", null, values);
    ...
    public ArrayList<String> getoutletName() {
        // TODO Auto-generated method stub
        ArrayList<String> outlet = new ArrayList<String>();
        String selectquery = "select DISTINCT outletname from outlet";

        Cursor cursor = database.rawQuery(selectquery, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                outlet.add("Select Outlet");
                do {
                    outlet.add(cursor.getString(cursor.getColumnIndex("outletname")));
                    Log.e("", "data product_type=" + outlet);
                } while (cursor.moveToNext());
    ...
    public void updateOutletStatus(long rowid) {
        String sql = "UPDATE supervisor_attendance SET outletstatus = 'DeActive' WHERE id != '" + rowid + "'";
        Log.e("local database", "sql=" + sql);
        database.execSQL(sql);
    ...
    public String getActiveoutletCode() {
        // TODO Auto-generated method stub
        String outletcode="";
        String selectquery = "select outletcode from supervisor_attendance where outletstatus = 'Active'";
        Cursor cursor = database.rawQuery(selectquery, null);
        if (cursor != null)
        {
            if (cursor.moveToFirst()) {
    ...
    public String getActiveoutletName() {
        ...
        String selectquery = "select outletname from outlet where outletcode IN (select outletcode from supervisor_attendance where outletstatus = 'Active')";
        Cursor cursor = database.rawQuery(selectquery, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    {
        String sql="SELECT DISTINCT sold_stock, total_gross_amount, total_net_amount, discount FROM stock WHERE db_id = '" + db_id + "' and outletcode ='" + outletcode + "'";
        Cursor c = database.rawQuery(sql, null);
        return c;

    }

    public boolean update1(String rowId ,String values[], String names[],
                           String tbl, String id,String outletcode) {
        ContentValues updateValues = createContentValues(values, names);

        return database.update(tbl, updateValues, id + "=" + rowId + " and outletcode = " + outletcode  , null) > 0;
    }
