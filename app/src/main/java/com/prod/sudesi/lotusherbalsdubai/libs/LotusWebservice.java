...
public class LotusWebservice {
	...
	/*public SoapPrimitive SaveStock(String id, String Pid, String CatCodeId,
		...
		try {
			...
			if (OutletCode == null || OutletCode.equalsIgnoreCase("null") ) {
	...
	public SoapObject GetBAOutletSales(String EmpID, String outletcode) {
	...
	/*public SoapObject SyncStockData(String empid, String lastsync_date) {
		...
		try {
			...
			Log.d("Date last servcer sync",""+lastsync_date+"-"+empid);
			SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(
					SoapEnvelope.VER11);// soap envelop with version
			envelope.setOutputSoapObject(request); // set request object
			envelope.dotNet = true;
			...
			HttpTransportSE androidHttpTransport = new HttpTransportSE(url);// http
																			// transport
																			// call
			androidHttpTransport.call("http://tempuri.org/IService1/SyncStockData", envelope);
	...
	public SoapObject GetVisibilityNotReceivedImage(String username) {
		...
		try {
			...
			result = (SoapObject) envelope.getResponse();
			Log.e("GetVisibilityNotImage=", result.toString());
	...
	public SoapPrimitive SaveStockEveryDayNetvalue(String Pid, String CatCodeId,
		...
		try {
			...
			result = (SoapPrimitive) envelope.getResponse();
			Log.v("","Log3");
			Log.e("InsertStockEveryDayNetv", result.toString());
	...
	public SoapPrimitive SaveSupervisorAttendance(String BDE_CODE, String BA_id, String Adate, String Actual_date, String lat, String lon, String outletCode)
	{
		SoapPrimitive result = null;
		try
		{
			...
			Log.e("SaveSupervisorAttendanc", request.toString());
			...
			result = (SoapPrimitive) envelope.getResponse();
			Log.e("SaveSupervisorAttendanc", result.toString());
...
//			request.addProperty("imageName", imgName);
	...
	*//*public SoapPrimitive UpdateTableData(String Id, String Updatedata,
	...
	public SoapObject GetDashboradData1(String id, String fromdate, String todate, String EMpid, String type, String outletcode){
	...
	public SoapObject TotalOutletSaleAPK(String EmpID, String fromdate, String todate)
		{
		SoapObject result = null;
		try {
