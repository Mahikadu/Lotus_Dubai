...
import com.prod.sudesi.lotusherbalsdubai.BuildConfig;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_logout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v.startAnimation(AnimationUtils.loadAnimation(AttendanceActivity.this, R.anim.button_click));
       ...
       /* initGoogleAPIClient();//Init Google API Client
        ...
        if (ContextCompat.checkSelfPermission(AttendanceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AttendanceActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_ID);
            return;
        }
 ...
 /*   // Getting lat and lon value using location liabarary and showing gps dialog
    ...
    private void showLocation(final Location location) {
        if (location != null) {
            ...
            SmartLocation.with(AttendanceActivity.this).location().stop();
    ...
    *//*  Show Popup to access User Permission  *//*
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AttendanceActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
